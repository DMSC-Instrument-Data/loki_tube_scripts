...
# Step 1: Loading SANS and transmission measurement files 
    ...
    MoveInstrumentComponent(Workspace=str(SampleSANS)+'_sans_nxs', ComponentName='some-sample-holder', Z=0.3053)
    ...
    Load(Filename=str(filepath)+'LARMOR000'+str(BackgroundTRANS)+'.nxs', OutputWorkspace=str(BackgroundTRANS)+'_trans_nxs')
...
#STEP 4:     
    ...
    CloneWorkspace(InputWorkspace='49334_sans_nxs', OutputWorkspace=str(SampleSANS)+'rear_1D_0.9_13.5_can_tmp')
