...
# Step 1: Loading SANS and transmission measurement files 
    ...
    MoveInstrumentComponent(Workspace='LARMOR000'+str(SampleSANS)+'_sans_nxs', ComponentName='some-sample-holder', Z=0.3053)
    MoveInstrumentComponent(Workspace='LARMOR000'+str(SampleSANS)+'_sans_nxs', ComponentName='DetectorBench', Y=0.001)

    Load(Filename=str(filepath)+'LARMOR000'+str(BackgroundSANS)+'.nxs', OutputWorkspace=str(BackgroundSANS)+'_sans_nxs')
    ...
    Load(Filename=str(filepath)+'LARMOR000'+str(BackgroundTRANS)+'.nxs', OutputWorkspace=str(BackgroundSANS)+'_trans_nxs')
    MoveInstrumentComponent(Workspace=str(BackgroundTRANS)+'_trans_nxs', ComponentName='some-sample-holder', Z=0.3053)
    MoveInstrumentComponent(Workspace=str(BackgroundTRANS)+'_trans_nxs', ComponentName='DetectorBench', Y=0.001)
...
#STEP 2: masking 
 ...
 #STEP 3: Set up and calculate transmission
    ...
    ExtractSpectra(InputWorkspace=str(BackgroundTRANS)+'_trans_nxs', OutputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', DetectorList='1,4')
    CalculateFlatBackground(InputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', OutputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', StartX=40000, EndX=99000, WorkspaceIndexList='0', Mode='Mean')
    CalculateFlatBackground(InputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', OutputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', StartX=88000, EndX=98000, WorkspaceIndexList='1', Mode='Mean')
    ConvertUnits(InputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', OutputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', Target='Wavelength')
    Rebin(InputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', OutputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', Params='0.9,-0.025,13.5')
    
    CalculateTransmission(SampleRunWorkspace=str(SampleTRANS)+'_trans_nxs_tmp', DirectRunWorkspace=str(SampleTRANS)+'_trans_nxs_tmp', OutputWorkspace=str(SampleTRANS)+'_trans_sample_0.9_13.5', IncidentBeamMonitor=1, TransmissionMonitor=4, RebinParams='0.9,-0.025,13.5', FitMethod='Polynomial', PolynomialOrder=3, OutputUnfittedData=True)
...
#STEP 4:     
    ...
    LoadRKH(Filename=str(filepath)+'DirectBeam_20feb_full_v3.dat', OutputWorkspace='__CalculateNormISIS_loaded_tmp')
    ...
    Multiply(LHSWorkspace='__CalculateNorm_loaded_temp', RHSWorkspace='__Q_WAVE_conversion_temp', OutputWorkspace='__Q_WAVE_conversion_temp')
    LoadRKH(Filename=str(filepath)+'ModeratorStdDev_TS2_SANS_LETexptl_07Aug2015.txt', OutputWorkspace='moderator_ws')
    ...
    ExtractSingleSpectrum(InputWorkspace=str(BackgroundSANS)+'_sans_nxs', OutputWorkspace='_Sample__monitor', WorkspaceIndex=0)
    ...
    ConvertUnits(InputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', OutputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', Target='Wavelength')
    Rebin(InputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', OutputWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', Params='0.9,-0.025,13.5')
    CalculateTransmission(SampleRunWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', DirectRunWorkspace=str(BackgroundTRANS)+'_trans_nxs_tmp', OutputWorkspace=str(BackgroundTRANS)+'_trans_can_0.9_13.5', IncidentBeamMonitor=1, TransmissionMonitor=4, RebinParams='0.9,-0.025,13.5', FitMethod='Polynomial', PolynomialOrder=3, OutputUnfittedData=True)
    CreateSingleValuedWorkspace(OutputWorkspace='__python_binary_op_single_value', DataValue=100)
    ...
    LoadRKH(Filename=str(filename)+'DirectBeam_20feb_full_v3.dat', OutputWorkspace='__CalculateNormISIS_loaded_tmp')
    ConvertToHistogram(InputWorkspace='__CalculateNormISIS_loaded_tmp', OutputWorkspace='__CalculateNormISIS_loaded_tmp')
    ...
    Multiply(LHSWorkspace='__CalculateNorm_loaded_temp', RHSWorkspace='__Q_WAVE_conversion_temp', OutputWorkspace='__Q_WAVE_conversion_temp')
    RebinToWorkspace(WorkspaceToRebin=str(BackgroundTRANS)+'_trans_can_0.9_13.5', WorkspaceToMatch=str(SampleSANS)+'rear_1D_0.9_13.5_can_tmp', OutputWorkspace='__CalculateNorm_loaded_temp')
    Multiply(LHSWorkspace='__CalculateNorm_loaded_temp', RHSWorkspace='__Q_WAVE_conversion_temp', OutputWorkspace='__Q_WAVE_conversion_temp')
    LoadRKH(Filename=str(filename)+'ModeratorStdDev_TS2_SANS_LETexptl_07Aug2015.txt', OutputWorkspace='moderator_ws')
    ConvertToHistogram(InputWorkspace='moderator_ws', OutputWorkspace='moderator_histogram_ws')
